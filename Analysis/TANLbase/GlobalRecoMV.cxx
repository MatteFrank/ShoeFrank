...
void GlobalRecoMV::BeforeEventLoop(){
  ...
  if(FootDebugLevel(1))
    cout<<"GlobalRecoMV::BeforeEventLoop start"<<endl;
  ...
  std::cout<<"Building the analysis chain\n";
...
void GlobalRecoMV::LoopEvent() {
  ...
  if(FootDebugLevel(1))
    cout<<"GlobalRecoMV::LoopEvent start"<<endl;
  if (fSkipEventsN>0) {
...
void GlobalRecoMV::AfterEventLoop(){
  ...
  if(FootDebugLevel(1))
    cout<<"GlobalRecoMV::AfterEventLoop start"<<endl;
...
void GlobalRecoMV::SetupTree(){
  ...
  if(FootDebugLevel(1))
    cout<<"GlobalRecoMV::SetupTree start"<<endl;
