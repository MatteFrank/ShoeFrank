...
/** \file TPGspectrumPlayer.h header file for TPGspectrumPlayer.cpp */
...
/** TPGspectrumPlayer to work on spectra
...
private:
   //! Current collection of peaks
   TSeqCollection *fPeakList;
   //! Inner list of peaks  
   TList *fInnerPeakList;
...
public:
   ...
   { DoBackground(TPGpadManager::GetHisto(),opt); }
