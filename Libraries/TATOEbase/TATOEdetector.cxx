...
/*!
 \file TATOEdetector.cxx
 \brief Detector class for TOE
...
//!
//! \param[in] cluster_ph a given cluster
...
//______________________________________________________________________________
//! generate candidates from a given plane
//!
//! \param[in] index_p a given plane index
...
//______________________________________________________________________________
//! return iterable tracks from vertices tracks
//!
//! \param[in] vertex_pch vector of vertices
    ...
    detector_properties< details::vertex_tag >::form_tracks( std::vector< TAVTvertex const * > vertex_pch ) const
{
    ...
    auto fill_l = [this]( std::vector< iterable_track >& track_pc, TAVTvertex const * vertex_h ) {
...
//______________________________________________________________________________
//                     MS2D
//! generate candidates from a given station
//!
//! \param[in] index_p a given station index
