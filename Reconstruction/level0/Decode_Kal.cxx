...
// cp -rf ~/MyScripts/newShoe/shoe/build/Reconstruction/level0/data/ ~/MyScripts/newShoe/Copy\ in\ build/.
// cp -rf ~/MyScripts/newShoe/shoe/build/Reconstruction/level0/DecodeMC_BO.C ~/MyScripts/newShoe/Copy\ in\ build/.

// cp -rf ~/MyScripts/newShoe/Copy\ in\ build/data ~/MyScripts/newShoe/shoe/build/Reconstruction/level0/.
// cp -rf ~/MyScripts/newShoe/Copy\ in\ build/DecodeMC_BO ~/MyScripts/newShoe/shoe/build/Reconstruction/level0/.
// mkdir  ~/MyScripts/newShoe/shoe/build/Reconstruction/level0/results
...
int main (int argc, char *argv[])  {
   ...
   GlobalRecoMC* globRec = new GlobalRecoMC("", in, nameOut);
   ...
   std::cout << "PROVA DECODEMC WITH GLOBALRECO" << std::endl;
   
   globRec->BeforeEventLoop();
   globRec->LoopEvent(200);
   // globRec->LoopEvent(-1);
