...
void TABMactNtuRaw::CreateHistogram(){
  ...
  fpHisDiscTime = new TH1F( "BM_Raw_DischargedTime", "Discharged time measurements; Time_meas-T0-trigger-Timecut or negative Time_meas [ns]; numevent", 500, -1000., 1000.);
  AddHistogram(fpHisDiscTime);

	fpHisMapX=new TH2I( "BM_Raw_cell_raw_occupancy_2d_x", "Cell occupancy for raw hits; z; x", 11, -5.5, 5.5,7, -2.8,2.8);
	AddHistogram(fpHisMapX);
	fpHisMapY=new TH2I( "BM_Raw_cell_raw_occupancy_2d_y", "Cell occupancy for raw hits; z; y", 11, -5.5, 5.5,7, -2.8,2.8);
