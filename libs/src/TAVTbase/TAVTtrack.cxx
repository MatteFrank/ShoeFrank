...
//______________________________________________________________________________
//
Float_t TAVTtrack::GetTheta() const
{
...
//______________________________________________________________________________
//
Float_t TAVTtrack::GetPhi() const
{
...
//______________________________________________________________________________
//
void TAVTtrack::SetValue(const TVector3& aOrigin, const TVector3& aSlope, const Float_t aLength)
{
   *fOrigin = aOrigin;
   *fSlope  = aSlope;
   fLength  = aLength;
...
//______________________________________________________________________________
//
TVector3 TAVTtrack::GetPoint(Float_t beta)
{
   TVector3 result;
   result = (*fSlope) * beta;
...
//______________________________________________________________________________
//
Float_t TAVTtrack::Distance(TVector3& p)
{
