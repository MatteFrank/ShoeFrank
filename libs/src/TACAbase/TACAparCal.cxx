...
//_______________________________________________
//! Get temparture parameter A
//!
//! \param[in] crysId crystal id
Double_t TACAparCal::GetParameterACry(Int_t crysId)
{
   return fMapCal->GetParameterACry(crysId);
}
...
//!
//! \param[in] crysId crystal id
Double_t TACAparCal::GetParameterBCry(Int_t crysId)
{
   return fMapCal->GetParameterBCry(crysId);
}
...
//!
//! \param[in] crysId crystal id
Double_t TACAparCal::GetParameterCCry(Int_t crysId)
{
   return fMapCal->GetParameterCCry(crysId);
}
