...
Bool_t TAEDbaseEventDisplay::fgIsGeoLoaded   = false;
Bool_t TAEDbaseEventDisplay::fgIsDisplayed   = false;
Bool_t TAEDbaseEventDisplay::fgGeoDone       = false;
Bool_t TAEDbaseEventDisplay::fgGUIFlag       = true;
Bool_t TAEDbaseEventDisplay::fgDisplayFlag   = true;
Int_t  TAEDbaseEventDisplay::fgMaxHistosN   =  4;

ClassImp(TAEDbaseEventDisplay)

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
TAEDbaseEventDisplay::TAEDbaseEventDisplay(const TString expName)
: TEveEventManager(),
  fExpName(expName),
  fWorldSizeZ(120),
  fWorldSizeXY(25),
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
TAEDbaseEventDisplay::~TAEDbaseEventDisplay()
{
   // default destructor
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void TAEDbaseEventDisplay::BuildDefaultGeometry()
{
   // World
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void TAEDbaseEventDisplay::DefineMaterial()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void TAEDbaseEventDisplay::SetWordMedium(TString materialChoice)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void TAEDbaseEventDisplay::SetWorldSizeZ(Float_t sizeZ)
{
   fWorldSizeZ  = sizeZ;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void TAEDbaseEventDisplay::SetWorldSizeXY(Float_t sizeXY)
{
   fWorldSizeXY = sizeXY;
}

//__________________________________________________________
void TAEDbaseEventDisplay::LoadGeometry(const Char_t* fileName)
{
   if (fgIsGeoLoaded)
      return;
...
//__________________________________________________________
void TAEDbaseEventDisplay::AddGeometry(TGeoVolume* volume, TGeoMatrix* transf)
{
   static Int_t nb = 0;
...
//__________________________________________________________
void TAEDbaseEventDisplay::SetTransparency(Char_t  transparency)
{
...
//__________________________________________________________
void TAEDbaseEventDisplay::ShowDisplay(const TString fileName)
{
   if (fgIsDisplayed) {
...
//__________________________________________________________
void TAEDbaseEventDisplay::MakeGUI()
{
   ...
   b->Connect("Clicked()", "TAEDbaseEventDisplay", this, "NextEvent()");
   
   b = new TGPictureButton(eventFrame, gClient->GetPicture(icondir + "ReloadPage.gif"));
   eventFrame->AddFrame(b);
   b->SetToolTipText("Loop Event");
   b->Connect("Clicked()", "TAEDbaseEventDisplay", this, "LoopEvent()");
   ...
   clearInfo->Connect("Clicked()","TAEDbaseEventDisplay",this,"ClearInfoView()");
   ...
   resetHisto->Connect("Clicked()","TAEDbaseEventDisplay",this,"ResetHisto()");
   ...
   fHistoListBox->Connect("Selected(Int_t)", "TAEDbaseEventDisplay", this, "HistoSelected(Int_t)");
...
//__________________________________________________________
void TAEDbaseEventDisplay::ClearInfoView()
{
   // clear log message
   fInfoView->Clear();
   fInfoView->ShowBottom();
...
void TAEDbaseEventDisplay::UpdateEventBar()
{
...
//__________________________________________________________
void TAEDbaseEventDisplay::LoopEvent(Int_t nEvts)
{
   if (!fgGUIFlag) {
      printf("TAEDbaseEventDisplay: No GUI available\n");
      return;
   }
...
//__________________________________________________________
void TAEDbaseEventDisplay::NextEvent()
{   
   LoopEvent(1);
}

//__________________________________________________________
void TAEDbaseEventDisplay::HistoSelected(Int_t /*id*/)
{
...
//__________________________________________________________
void TAEDbaseEventDisplay::ResetHisto()
{
