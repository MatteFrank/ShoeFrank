...
#ifndef TAEDbaseEventDisplay_h
#define TAEDbaseEventDisplay_h 1
...
class TAEDbaseEventDisplay : public TEveEventManager
{
public:
   TAEDbaseEventDisplay(const TString expName = "");
   virtual ~TAEDbaseEventDisplay();
...
protected:
   ...
   ClassDef(TAEDbaseEventDisplay, 1); // Base class for event display
