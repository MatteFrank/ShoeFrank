/*!
 \file TCLINMtrackingAction.cxx
 \brief Implementation of TCLINMtrackingAction.
*/
...
#include "TCLINMtrackingAction.hxx"
...
map<TString, Int_t> TCLINMtrackingAction::fgkVolumeToRegion = {{"World",0}, {"StartCounter",10}, {"BM",20}, {"BeamMonitor",20}, {"Gaz",21}, {"Foil", 22},{"targetPhy",30},{"Vertex",40},{"vtxEpiPhy",40},{"Magnets",50}, {"itEpiPhy",60}, {"msdEpiPhy",70}, {"Tof",80}, {"Calo",90}};

/*!
 \class TCLINMtrackingAction
 \brief  Tracking action for FOOT
 */

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Constructor
TCLINMtrackingAction::TCLINMtrackingAction(TCLINMbaseEventAction* aEventAction)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Destructor
TCLINMtrackingAction::~TCLINMtrackingAction()
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Pre user tracking action
void TCLINMtrackingAction::PreUserTrackingAction(const G4Track*)
{
}
...
void TCLINMtrackingAction::PostUserTrackingAction(const G4Track* aTrack)
{
