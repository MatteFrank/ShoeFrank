/*!
 \file TCLINMrunAction.cxx
 \brief Implementation of TCLINMrunAction.
*/
...
TString TCLINMrunAction::fgRootFileName = "ionCa1000.root";
...
//! Constructor
TCLINMrunAction::TCLINMrunAction()
: G4UserRunAction(),
  fpEventMC(0x0),
  fpOutFile(0x0),
  fpTree(0x0),
...
void TCLINMrunAction::BeginOfRunAction(const G4Run* aRun)
{
...
//!
//! \param[in] aRun a given run
void TCLINMrunAction::EndOfRunAction(const G4Run* aRun)
{
...
void TCLINMrunAction::FillAndClear(Bool_t fill)
{
    if (fill)
       fpTree->Fill();
    ClearContainers();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Set containers
void TCLINMrunAction::SetContainers()
{
   //File for
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Clear containers
void TCLINMrunAction::ClearContainers()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//! Print tree branches
void TCLINMrunAction::PrintBranches()
{
  if (!fpTree) return;
