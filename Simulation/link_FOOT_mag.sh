...
$FLUPRO/flutil/ldpmqmd -m fluka PRO/usrini.o usrout.o PRO/usreou.o usrein.o  mgdraw.o magfld.o mgdraw_lib.o source.o UpdateCurrentParticle.o -o fluka_FOOT_mag.exe
